...
- [Download for Apple silicon](https://github.com/Girisankarsm/shrinkOs/releases/download/v0.1.1/ShrinkOS_0.1.1_aarch64.dmg)
- [Download for Intel](https://github.com/Girisankarsm/shrinkOs/releases/download/v0.1.1/ShrinkOS_0.1.1_x64.dmg)
...
Pushing a version tag such as `v0.1.1` runs the GitHub Actions release workflow,
